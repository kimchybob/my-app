...
public class RaftNode {
     ...
     *
     * note: I am a leader and i receive a hb with a term = mine will not happen in raft.
     * @since 1.0
     */
    private void processHb(Message msg) {
        ...
        if (msg.getCurrentTerm() > currentTerm || state == NodeState.CANDIDATE) { //case: i am leader in old term , but a new leader elected
